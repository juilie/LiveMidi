...
Tunnel.prototype.addTorus = function () {
  ...
  const torusGeometry = new THREE.TorusGeometry( size, size, 10 ); 
  // const coneGeometry = new THREE.TorusKnotGeometry(.003, .001, 100, 16);
  const coolMaterial = new THREE.MeshPhysicalMaterial({
    color: 0x00ffff,
    roughness: 0.0,
  ...
  const torus = new THREE.Mesh(torusGeometry, coolMaterial);

  // const sphere = new THREE.Mesh(sphereGeometry, sphereMaterial);
  torus.position.z = 0.55
  // torus.rotateX = Math.random()
  torus.rotation.x = (Math.random() - 0.5) * 2
  torus.rotation.y = (Math.random() - 0.5) * 2
  torus.rotation.z = (Math.random() - 0.5) * 2
...
Tunnel.prototype.addOcta = function () {
  const size = Math.abs(Math.random() + 1) * .005
  const octaGeometry = new THREE.OctahedronGeometry( size, 0 ); 
  ...
  const octahedron = new THREE.Mesh(octaGeometry, coolMaterial);

  // const sphere = new THREE.Mesh(sphereGeometry, sphereMaterial);
  octahedron.position.z = 0.55
  // octahedron.rotateX = Math.random()
  octahedron.rotation.x = (Math.random() - 0.5) * 2
  octahedron.rotation.y = (Math.random() - 0.5) * 2
  octahedron.rotation.z = (Math.random() - 0.5) * 2
  // octahedron.rotation.y = Math.random()
...
Tunnel.prototype.addCube = function () {
  const size = Math.abs(Math.random() + 1) * .005
  ...
  const cube = new THREE.Mesh(cubeGeo, coolMaterial);
  ...
  // cube.position.z =  Math.random() * 0.1 + 0.5
  cube.position.y = (Math.random() - .5) * 0.04
  cube.position.x = (Math.random() - .5) * 0.04 +.02
...
Tunnel.prototype.updateShapes = function () {
  ...
  if (this.shapes.length > 100) {
    ...
    this.scene.remove(this.shapes[0])
  }
